...
const emptyPig = { tag_number: '', name: '', breed: '', sex: 'piglet', date_of_birth: '', date_acquired: today(), purchase_price: '', weight_kg: '', litter_number: '', notes: '' };
...
export default function Pigs() {
  ...
  const addSaleMut = useMutation({
    mutationFn: (data) => createLivestockSale({ ...data, animal_type: 'pig' }),
